...
import { CreateTeamDrawer } from "./create-team-drawer.js";
import { EditTeamDrawer } from "./edit-team-drawer.js";
    ...
    () => [
      ...
      columnHelper.display({
        ...
        cell: (info) => {
          ...
          return <span className="text-sm text-slate-700 dark:text-slate-300">{desc || "—"}</span>;
        },
      }),
      columnHelper.display({
        id: "created",
      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            {canManageTeams && <CreateTeamDrawer onSuccess={() => void refetchTeams()} />}
          </div>
        }
      />
